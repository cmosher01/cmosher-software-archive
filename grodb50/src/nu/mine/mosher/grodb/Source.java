...
public class Source
{
	...
	private List<Relation<Source,Source,SourceRelType>> rRel = new ArrayList<Relation<Source,Source,SourceRelType>>();
	...
	{
		rRel.add(new Relation<Source,Source>(this,that,descriptionThisToThat));
	}
}
