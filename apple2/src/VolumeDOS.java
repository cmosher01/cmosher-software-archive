...
//    0x0A00-0x0BFF // T$00,S$A-$B DOS reloc routine
    ...
    private static final int[] rSlave1980 = {0x0060, 0x0068, 0x006D, 0x0070, 0x0073, 0x0078, 0x007D, 0x0082, 0x0085, 0x0088,
            ...
            0x0124, 0x0129, 0x013A, 0x0140, 0x0143, 0x0149, 0x014C, 0x0150, 0x0153, 0x0156, 0x0159, 0x015C, 0x0161, 0x0166, 0x016B, 0x016E,
            ...
            0x0C01, 0x0C03, 0x0C05, 0x0C07, 0x0C09, 0x0C0B, 0x0C0D, 0x0C0F, 0x0C11, 0x0C13, 0x0C15, 0x0C17, 0x0C19, 0x0C1B, 0x0C1D, 0x0C1F,
            0x0C21, 0x0C23, 0x0C25, 0x0C27, 0x0C29, 0x0C2B, 0x0C2D, 0x0C2F, 0x0C31, 0x0C33, 0x0C35, 0x0C37, 0x0C39, 0x0C3B, 0x0C3D,
            0x0C3F, 0x0C41, 0x0C43, 0x0C45, 0x0C47, 0x0C49, 0x0C4B, 0x0C4D, 0x0C4F, 0x0C51, 0x0C53, 0x0C55, 0x0C57, 0x0C59, 0x0C65, 0x0C6D, 0x0C6F,
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < rbCmp.length; ++i)
                        {
                            ...
                            {
                                System.err.println(Integer.toHexString(rbClearSlave[i])+" --> "+Integer.toHexString(rbCmp[i]));
                            }
                        }
                    }
                }
