...
PRENIB1         DEY
                ...
                LSR A           ; PUT ITS LWR 2 BITS INTO RWTSBUF1.
                ROL RWTSBUF2,X
                LSR A
                ROL RWTSBUF2,X
...
TURNON          SEC             ; (C)=1 SO GET ODD INDEX TO BASE
                ...
                JSR ONOROFF     ; TURN MAGNET ON TO SUCK STEPPER
                                ; MOTOR TO CORRECT HALFTRACK POS'N.
...
ONOROFF         LDA PRESTRK     ; USE HALFTRK POS'N TO INDEX MAGNET
...
N2NOFF = $A8
                .RES 3
                .BYTE $00,$01,$08,$10,$18,$02,$03,$04,$05,$06,$20,$28,$30,$07,$09,$38
                .BYTE $40,$0A,$48,$50,$58,$0B,$0C,$0D,$0E,$0F,$11,$12,$13,$14,$15,$16
                .BYTE $17,$19,$1A,$1B,$1C,$1D,$1E,$21,$22,$23,$24,$60,$68,$25,$26,$70
                .BYTE $78,$27,$80,$88,$90,$29,$2A,$2B,$2C,$2D,$2E,$2F,$31,$32,$33,$98
                .BYTE $A0,$34,$A8,$B0,$B8,$35,$36,$37,$39,$3A,$C0,$C8,$D0,$3B,$3C,$D8
                .BYTE $E0,$3E,$E8,$F0,$F8
                .ELSE
                                ; ==================================
...
RWTSBUF2
                ...
                .IF VERSION < 330
DSKNBTBL        .BYTE $AB,$AD,$AE,$AF
                .BYTE $B5,$B6,$B7,$BA,$BB,$BD,$BE,$BF
                .BYTE $D6,$D7,$DA,$DB,$DD,$DE,$DF
                .BYTE $EA,$EB,$ED,$EE,$EF
                .BYTE $F5,$F6,$F7,$FA,$FB,$FD,$FE,$FF
...
PHYSECTR13      .BYTE $00,$05,$0A,$02,$07,$0C,$04,$09,$01,$06,$0B,$03,$08
                .RES 35
                .ELSE
...
FREE1
                ...
                .IFDEF FRANKLIN ; CAM: This is the only difference in Franklin's DOS
