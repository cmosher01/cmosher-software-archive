...
portability in mind. It relies on the
...
include::a2library.asciidoc[]

Copyright (C) 2009,2012, by mailto:chris-keyword-epple2.4a8db3@mosher.mine.nu[Christopher A. Mosher].

This web site is licensed under the
http://creativecommons.org/licenses/by-nc-sa/3.0/us/[image:80x15.png[Creative Commons Attribution-Noncommercial-Share Alike 3.0 USA License]]
