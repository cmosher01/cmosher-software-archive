...
/**
 * Reads all lines from a script type file.
 * Each line will be stripped of EOL-style comments (beginning
 * with the given comment character), then trimmed. Blank lines
 * (after the above cleaning) are ignored.
 *
 * @author Chris Mosher
 */
public class Script
{
	...
	/**.
	 * Initializes this Script to read line from the given BufferedReader,
	 * and use the given character as an EOL comment character.
	 * @param in
