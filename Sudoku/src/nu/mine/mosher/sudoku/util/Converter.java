...
/**
 * Contains static methods to convert
 * box/square to and from row/column.
 * The number scheme for boxes (within the board) and
 * squares (within a box) is a follows, visually:
 * <pre>
 * 0 1 2
 * 3 4 5
 * 6 7 8
