...
public class ValidityChecker
{
	...
	/**
	 * Checks the game (passed into the constructor) to make sure
	 * it has no invalid squares. An invalid square is one that
	 * has all of its possibilities eliminated.
