...
/**
 * Checks a given (finished) game to see if it has
 * been correctly solved according to the rules of sudoku.
 *
 * @author Chris Mosher
 */
class AnswerChecker
{
	...
	/**
	 * Checks the game (passed into the constructor) to see
	 * if it has been correctly solved.
