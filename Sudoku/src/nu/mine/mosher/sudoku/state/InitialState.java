...
/**
 * Represents a sudoku puzzle, in its initial state. The puzzle
 * contains 9 boxes or 9 squares each. Each square will either have
 * an "answer" (a number 0 through 8 representing the answer 1 through 9)
 * or not. Objects of this class are immutable.
 *
 * @author Chris Mosher
 */
class InitialState
{
	...
	/**
	 * Creates a new <code>InitialState</code> representing the current
	 * state of the given game.
	 * @param stateGetFrom
	...
	/**
	 * Creates a new <code>InitialState</code> from a string of
	 * 81 numbers. Zeros or non-digts represent empty squares.
	...
	/**
	 * Checks if this state has an answer in the given
	 * square. Square's are numbered 0-8 in row-major order,
	 * with a box ("SBox"), which are also numbered 0-8
	 * in row-major order.
	 * @param sbox
	 * @param square
	...
	/**
	 * Gets the answer in the given square. Throws an assertion
	 * exception is the given square does not have an answer.
	 * Square's are numbered 0-8 in row-major order,
	 * with a box ("SBox"), which are also numbered 0-8
	 * in row-major order.
	 * @param sbox
	 * @param square
