...
/**
 * Represents a (possibly partially or fully) solved sudoku puzzle.
 * Contains information about the answers of each square, and also
 * for those squares that do not have answers the possibilities that
...
class GameState
{
	...
	/**
	 * Checks if the given possibility has been eliminated from
	 * the given square.
	 * @param sbox
	 * @param square
	...
	/**
	 * Checks if the given square has an answer. This is equivalent
	 * to the square having all but one possibility eliminated.
	 * @param sbox
	 * @param square
	...
	/**
	 * Gets the answer in the given square. Throws an exception
	 * if the square does not have an answer.
	 * @param sbox
	 * @param square
	...
	/**
	 * Makes a given move from the given state. Returns a new state
	 * representing the puzzle after the move has been made.
	 * @param from
	 * @param move
