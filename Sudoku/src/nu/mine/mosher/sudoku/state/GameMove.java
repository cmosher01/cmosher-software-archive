...
/**
 * Represents one move in the game. This will usually be the
 * elimination of one possible number from a square. Other options
 * include affirming an answer in a square, or re-enabling a
 * possibility that had previously been eliminated.
 *
 * @author Chris Mosher
 */
class GameMove
{
	 ...
	 * @param auto 
	 */
	public GameMove(final Time time, final int sbox, final int square, final int possibility, final GameMoveType move, final MoveAutomationType auto)
	{
		this.time = time;
		this.sbox = sbox;
		this.square = square;
	...
	/**
	 * Factory method, reading a move from a given string, in the format
	...
	public boolean equals(final Object object)
	{
		...
		return
			...
			this.possibility == that.possibility &&
			this.move.equals(that.move) &&
			this.auto.equals(that.auto);
	}
