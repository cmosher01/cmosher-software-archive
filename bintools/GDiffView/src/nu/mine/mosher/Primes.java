 ...
 * Westminster, BC Canada V3M 5T9 tel: (604) 777-1804 mailto:roedy@mindprod.com
 * http://mindprod.com
 */
...
/**
 * @author Roedy Green
 * @version 1.10 1998 November 10 Calculate primes using Eratostheses Sieve.
 * Tell if a given number is prime. Find a prime just below a given number. Find
 * a prime just above a given number.
 */
...
public class Primes
{
    ...
    /**
     * Ensure have a sieve to tackle primes as big as n. If we don't allocate a
