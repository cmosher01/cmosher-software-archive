...
public class BinDiff
{
	...
	public void diff()
	{
		BufferedInputStream in1 = getBuffered(f1);
		BufferedInputStream in2 = getBuffered(f2);
	}

	protected BufferedInputStream getBuffered(InputStream in)
	{
