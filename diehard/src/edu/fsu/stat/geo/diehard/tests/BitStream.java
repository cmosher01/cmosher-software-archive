...
public class BitStream extends RandomnessTest
{
//    private static final int nb_pw = 20;
//    private static final int power = 21;
//    private static final int no_obs = 20;
//    private static final int no_bits = (int)Math.pow(2,power-5);
//    private static final int no_wds = (int)Math.pow(2,power);
//    private static final int dim = (int)Math.pow(2,nb_pw - 5);
//    private static final int mask = (int)Math.pow(2,nb_pw) - 1;
//    private static final double mean = Math.pow(2,nb_pw) * Math.exp(-Math.pow(2,power-nb_pw));
    //private static final int nb_pw = 20;
    //private static final int power = 21;
    private static final int no_obs = 20;
    ...
    private static int[] wds = new int[dim];
    ...
    public BitStream(RandomNumberGenerator rng)
    {
        super(rng);
    }
