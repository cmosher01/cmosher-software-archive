...
//        System.out.println( r.x + ":" +  r.y + ":" +  r.width + ":"+ r.height);
        ...
        g.drawLine(r.x + r.width, cy - 2, xe, cy - 2); // draw right line, use default color
        ...
        while( e.hasMoreElements() ) {
            ...
            if(tagname != null) {
                ...
                if( nexttag.getPositionSize() == null ) {
                    ...
                    x += width;
                    if( x > PanelWidth) return; // can't display the reset
                }
    ...
    public boolean addTag(String tag) {
        ...
        if(taglist.size() >= MAX_TAG ) return false;
    ...
    public void mouseClicked(MouseEvent msevt) {
        ...
        while( e.hasMoreElements() ) {
            ...
            if( r.contains(p)) {
                ...
                if( upperTag == ctag ) return;  // clicked on upper tag
                upperTag = ctag;
                repaint();
