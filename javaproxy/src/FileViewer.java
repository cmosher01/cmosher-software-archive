...
public class FileViewer extends Frame {
    ...
    public FileViewer(String filename) {
        ...
        try {
            ...
            while(bytes_read < fsize) bytes_read += in.read(buffer, bytes_read, fsize-bytes_read);
        }
        catch (IOException e) { }
    ...
    public void processWindowEvent(WindowEvent winevt) {
        if( winevt.getID() == Event.WINDOW_DESTROY ) this.setVisible(false);
    }
