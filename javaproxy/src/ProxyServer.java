...
public class ProxyServer implements Runnable {
    ...
    public synchronized boolean startServer() {
        ...
        if( server_running ) return true; // check if server is running already
        ...
        try {
            ...
            ss = null;
            if(debug_mode) System.out.println("Error: Can't set up server socket on " + server_ip + ":" + server_port + "\n" + e );
            return false;
        }
    ...
    public synchronized boolean stopServer() {
        ...
        try {
            ...
            if(debug_mode) System.out.println("Can't close server socket");
        }
        ss = null;
