/**
 * @(#)Folder.java April 3, 1998 I MAKE NO WARRANTIES ABOUT THE SUITABILITY OF
...
/**
 * Folder is used to contains configuration pages. It has 2 buttons, 'Save' and
 * 'Cancel'. When 'Save' is clicked, it calls the parent callback function to
 * save the configuration parameters. It exits when 'Cancel' is clicked.
 */
class Folder extends Dialog implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent evt)
    {
        ...
        if ((evt.getActionCommand()).equals("Save"))
        {
            ...
            if (controller != null)
                si = (ConfigInterface)controller;
            else
                si = (ConfigInterface)parent;
