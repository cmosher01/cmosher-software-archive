/**
 * @(#)MessageWindow.java April 3, 1998 I MAKE NO WARRANTIES ABOUT THE
...
class MessageWindow extends Frame implements ActionListener
{
    ...
    public void processWindowEvent(WindowEvent winevt)
    {
        ...
        super.processWindowEvent(winevt); // parent class need to handle the
                                          // event too
    ...
    private void print_content()
    {
        ...
        /*
         * pg.setFont(cur_font); // ok int x = 0; int y = 0; String fcontent =
         * MessageArea.getText(); StringTokenizer st = new
         * StringTokenizer(fcontent, "\n"); while (st.hasMoreTokens()) {
         * pg.drawString(st.nextToken(), x, y); y += font_height; }
         */
        printAll(pg);
        pg.dispose();
        pj.end();
