/**
 * @(#)byteArrayOperator.java April 3, 1998 I MAKE NO WARRANTIES ABOUT THE
...
public class byteArrayOperator
{
    ...
    /**
     * check if this byte array is printable true if printable is 3 times or
     * greater the number of none-printable
     */
