/**
 * @(#)HTTPResponseHeader.java April 3, 1998 I MAKE NO WARRANTIES ABOUT THE
...
/**
 * This class contains common functions for parsing HTTP response headers and
 * has member elements for storing header values.
 */
