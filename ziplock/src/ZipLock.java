...
public class ZipLock
{
	...
	private final Map<String,String> m_dep = new HashMap<String,String>();
	private int m_level = 0;
	private ZipOutputStream m_archiveStream;
	private static final String filesep = System.getProperty("file.separator");
	private static final String[] classPath = getClassPath();
	private final List<String> rootSet = new ArrayList<String>();
	private static final Map ziptbl = new HashMap(); // cache jars
	...
	private final List<Pair> methInfo = new ArrayList<Pair>();
	...
	{
		return rootSet.toArray(new String[rootSet.size()]);
	}
	...
	{
		return m_dep.keySet().toArray(new String[m_dep.size()]);
	}
		...
		readcp: for (int i = 1; i < count; i++)
		{
			...
			switch (tag)
			{
				...
				case 10: // CONSTANT_Methodref
					...
					methInfo.add(new Pair(clazz,nt));
				break;
	...
	public static void main(String[] argv) throws Exception
	{
		if (argv.length < 1)
		{
			System.err.print("	$Id: ZipLock.java,v 1.10 2000/11/25 04:26:56 stuart Exp $\n"
				+ "	Finds all dependencies of selected classes.\n"
