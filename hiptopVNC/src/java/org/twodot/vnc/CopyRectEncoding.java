...
public class CopyRectEncoding extends Encoding {

	private long stat_bytes = 0;
	private long stat_rects = 0;

	CopyRectEncoding(rfbProto r, Bitmap b) {
		super(r,b);
	}
	...
	public int  getEncodingID() { return rfbProto.EncodingCopyRect; }
	public String getName() { return "CopyRect"; }

	public void doEncoding() throws IOException {
		int x = rfb.updateRectX;
		int y = rfb.updateRectY;
		int w = rfb.updateRectW;
		int h = rfb.updateRectH;
	...
	public void doEncoding(int x, int y, int w, int h) throws IOException {
		...
		//System.out.println("CopyRect encoding from CopyRectEncoding Class!");

		int srcX = rfb.copyRectSrcX;
		int srcY = rfb.copyRectSrcY;

		stat_rects++;
		fb.copyBitsTo(fb, Rect.newXYWH(x, y, w,h),
								Rect.newXYWH(srcX,srcY,w,h));
	}
