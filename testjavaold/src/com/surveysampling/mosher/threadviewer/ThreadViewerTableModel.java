package com.surveysampling.mosher.threadviewer;
        ...
        String[] names =
            {
                ...
                "Daemon",
                "Interrupted",
                "Name of ThreadGroup that Thread is from",
                "ParentGroup",
                "Thread Name" };
        columnName = names;

        // JTable uses this information for cell rendering
        Class[] classes = { Integer.class, Boolean.class, Boolean.class, Boolean.class, String.class, String.class, String.class };
        columnClass = classes;
