 ...
 * 
 */
public class GetPrevPageOnButtonSheetQueryImplTest extends TestCase
{
    ...
    /**
     * Test method for {@link com.ipc.uda.types.GetPrevPageOnButtonSheetQueryImpl#execute()}.
     */
    @Test
    public void testExecute()
    {
        ...
        final GetPrevPageOnButtonSheetQueryImpl buttonSheetQry = new GetPrevPageOnButtonSheetQueryImpl();
        buttonSheetQry.setUserContext(user);
        qry.setGetPrevPageOnButtonSheet(buttonSheetQry);
        req.setQuery(qry);
        final Executable exe = req.getExecutable();
        Assert.assertTrue(exe instanceof GetPrevPageOnButtonSheetQueryImpl);
    }
