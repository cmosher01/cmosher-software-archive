 ...
 * 
 */
public class GetButtonSheetForThePageQueryImplTest extends TestCase
{
    ...
    public void testExecute() throws ExecutionException
    {
        ...
        final GetButtonSheetForThePageQueryImpl buttonSheetQry = new GetButtonSheetForThePageQueryImpl();
        buttonSheetQry.setPageNumber(2);
        buttonSheetQry.setUserContext(user);
        qry.setGetButtonSheetForThePage(buttonSheetQry);
        req.setQuery(qry);
        final Executable exe = req.getExecutable();
        Assert.assertTrue(exe instanceof GetButtonSheetForThePageQueryImpl);
        GetButtonSheetForThePageQueryImplTest.context = new BasicSecurityContext("root", "root");
