 ...
 * 
 */
public class GetContactHistoryFromButtonPageQueryImplTest extends TestCase
{
    ...
    /**
     * Test method for {@link com.ipc.uda.types.GetContactHistoryFromButtonPageQueryImpl#execute()}.
     */
    @Test
    public void testExecute()
    {
        ...
        final GetContactHistoryFromButtonPageQueryImpl ctHist = new GetContactHistoryFromButtonPageQueryImpl();
        ctHist.setUserContext(user);

        final UID uid = new UID("" + 1);
        ctHist.setButtonId(uid);
        qry.setGetContactHistoryFromButtonPage(ctHist);
        req.setQuery(qry);
        final Executable exe = req.getExecutable();
        Assert.assertTrue(exe instanceof GetContactHistoryFromButtonPageQueryImpl);
    }
