 ...
 * 
 */
public class UpdateUserConfigurationCommandImplTest extends TestCase
{
    ...
    public void testExecute() throws ExecutionException
    {
        ...
        final CommandType qry = new CommandType();
        final UpdateUserConfigurationCommandImpl updateUserConfCommand = new UpdateUserConfigurationCommandImpl();
        final CommandType cmd = new CommandType();
        updateUserConfCommand.setUserContext(user);

        cmd.setUpdateUserConfiguration(updateUserConfCommand);
        req.setCommand(cmd);
        final Executable exe = req.getExecutable();
        Assert.assertTrue(exe instanceof UpdateUserConfigurationCommandImpl);
