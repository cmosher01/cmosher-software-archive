 ...
 * @author sharmar
 */
public class ReleaseSpeakerChannelCommandImpl extends ReleaseSpeakerChannelCommand implements
    ...
    public Optional<ExecutionResult> execute() throws ExecutionException
    {
        ...
        if (!optSpeaker.exists())
        {
            throw new ExecutionException(
                    "Received Release Speaker Channel Command with unknown speaker channel number: "
            ...
            try
            {
                ...
                speaker.getCall().udacReleaseSpeakerChannel();
                
                final UserSpeakerChannel dsSprChnl = speaker.getDsSpeaker();
                dsSprChnl.setActiveStatus(false);
