...
public class StateChangeMonitorFull implements StateChangeMonitor
{
	...
	public StateChangeMonitorFull(final FSMContext fsm, final StateChangeListener listener)
	{
		this.fsm = fsm;
